...
namespace SGEntregasAlbertoSheila
{
    ...
    public partial class clientes : INotifyPropertyChanged, ICloneable
    {
        ...
        public string dni
        {
            ...
            set
            {
                dni_ = value; notificarPropertyChanged();
        ...
        public string nombre
        {
            ...
            set
            {
                nombre_ = value; notificarPropertyChanged();
        ...
        public string apellidos
        {
            ...
            set
            {
                apellidos_ = value; notificarPropertyChanged();
        ...
        public string email
        {
            ...
            set
            {
                email_ = value; notificarPropertyChanged();
        ...
        public string domicilio
        {
            ...
            set
            {
                domicilio_ = value; notificarPropertyChanged();
        ...
        public string localidad
        {
            ...
            set
            {
                localidad_ = value; notificarPropertyChanged();
        ...
        public int provincia
        {
            ...
            set
            {
                provincia_ = value; notificarPropertyChanged();
